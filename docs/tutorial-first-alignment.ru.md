...
Нажмите **«+ Создать»** в правом верхнем углу. В диалоге выберите **«Выравнивание»**:

![Диалог создания выравнивания](assets/screenshots/aligner-create-alignment-dialog.png)

На втором шаге откроется форма выравнивания:

1. **Название** — дайте выравниванию описательное имя, например «Синяя герань EN-RU».
2. **Исходный документ** — выберите загруженный английский документ.
3. **Целевой документ** — выберите русский документ.

Нажмите **«Создать выравнивание»**, чтобы инициализировать проект. Система разобьёт тексты на пакеты (батчи) и подготовит базу данных выравнивания.
