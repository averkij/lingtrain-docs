...
## Работа с прокси-аннотациями {#proxy-annotations}

Когда для выравнивания загружены прокси-документы, редактор может отображать прокси-переводы в виде подстрочных аннотаций под каждым предложением.

Переключите видимость прокси с помощью переключателя **«Show subscriptions»** в заголовке панели Conflicts.

Прокси-аннотации полезны для:

- **Проверки выравнивания незнакомых языков** — если вы не читаете на одном из языков, прокси-перевод (на знакомом вам языке) помогает подтвердить правильность пар.
- **Проверки качества прокси** — сравнения прокси-перевода с оригиналом для выявления проблем.
